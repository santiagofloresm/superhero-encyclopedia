<template>
  <v-container class="detailed-container">
    <v-layout>
      <v-flex>
        <v-row class="top-row">
          <v-col md="4">
...
<script lang="ts">
import Vue from 'vue';
import StatsProgressBar from "@/components/UI/StatsProgressBar.vue";
...
export default Vue.extend({
  ...
  computed: {
    ...
    superhero: {
      get: function () {
        return this.getSuperheroByName(this.$route.params.name)
      }
    }
  }
})
